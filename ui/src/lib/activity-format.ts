...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "issue.push_state_gap": "closed with unpushed commits on",
  "issue.push_state_skipped": "could not check the push state of",
...
const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "issue.push_state_gap": "Closed while the branch had unpushed commits",
  "issue.push_state_skipped": "Push-state check could not run at close",
